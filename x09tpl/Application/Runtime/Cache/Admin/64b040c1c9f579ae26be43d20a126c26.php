	...
	<div id="mws-header" class="clearfix">
        ...
        <div id="mws-user-tools" class="clearfix">
        	...
        	<div id="mws-user-notif" class="mws-dropdown-menu">
            	<a href="/x09tpl/Public/#" data-toggle="dropdown" class="mws-dropdown-trigger"><i class="icon-exclamation-sign"></i></a>
    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    <li>
                        <a href="/x09tpl/Public/#"><i class="icon-user"></i> 用户管理</a>
                        <ul class="closed">
                    ...
                    <li>
                        <a href="/x09tpl/Public/#"><i class="icon-th-list"></i> 分类管理</a>
                        <ul class="closed">
                    ...
                    <li>
                        <a href="/x09tpl/Public/#"><i class="icon-file"></i> 商品管理</a>
                        <ul class="closed">
...
<div id="mws-container" class="clearfix">
	...
	<script type="text/javascript" charset="utf-8" src="/x09tpl/Public/admin/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/x09tpl/Public/admin/ueditor/ueditor.all.min.js"> </script>
    <!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
    <!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
    <script type="text/javascript" charset="utf-8" src="/x09tpl/Public/admin/ueditor/lang/zh-cn/zh-cn.js"></script>
<div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        <span><i class="icon-pencil"></i>商品添加</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <form class="mws-form" action="/x09tpl/index.php/Admin/shop/update" method="post" enctype="multipart/form-data">
                            
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label class="mws-form-label">商品名</label>
                                    <div class="mws-form-item">
                                        <input class="large" type="text" value="<?php echo ($list['name']); ?>" name="name" required oninvalid="setCustomValidity('商品名空')" oninput="setCustomValidity('')">
                                    </div>
                                </div>                                                          
                                <div class="mws-form-row">
                                    <label class="mws-form-label">价格</label>
                                    <div class="mws-form-item">
                                        <input class="large" type="text" value="<?php echo ($list['price']); ?>" name="price" required oninvalid="setCustomValidity('价格不能空')" oninput="setCustomValidity('')">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">发源地</label>
                                    <div class="mws-form-item">
                                        <input class="large" type="text" value="<?php echo ($list['address']); ?>" name="address" required oninvalid="setCustomValidity('请填写发源地')" oninput="setCustomValidity('')">
                                    </div>
                                </div> 
                                <div class="mws-form-row">
                                    <label class="mws-form-label">库存量</label>
                                    <div class="mws-form-item">
                                        <input class="large" type="text" name="num" value="<?php echo ($list['num']); ?>" required oninvalid="setCustomValidity('数量不能为空')" oninput="setCustomValidity('')">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">商品原图片</label>
                                    <div class="mws-form-item">
                                 ...
                                 <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <script id="editor" type="text/plain"  name="descr" value="<?php echo ($list['descr']); ?>" style="width:950px;height:300px;"></script>
                                    </div>
                                </div>
                                <div class="mws-form-row">
