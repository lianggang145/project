...
<div class="mws-panel grid_8 mws-collapsible">
    ...
    <div class="mws-panel-inner-wrap"><div class="mws-panel-body no-padding">
        ...
        <form action="/x09tpl/index.php/Admin/shop/index" method="get">
        ...
        <thead>
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 156px;" aria-label="Browser: activate to sort column ascending">商品名</th>
          ...
          <?php if(is_array($list)): foreach($list as $key=>$row): ?><tr class="even" align="center">
                ...
                <td class=" ">
                    <span class="btn-group">            
                        <a href="/x09tpl/index.php/Admin/Shop/edit/id/<?php echo ($row['id']); ?>" class="btn btn-small"><i class="icon-pencil"></i></a>
                        <a href="/x09tpl/index.php/Admin/Shop/del/id/<?php echo ($row['id']); ?>" class="btn btn-small"><i class="icon-trash"></i></a>
                    </span>
