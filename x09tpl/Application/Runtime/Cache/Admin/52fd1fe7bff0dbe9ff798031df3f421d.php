...
<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="/x09tpl/index.php/Admin/user/update" method="post">
                        	
                        	<div class="mws-form-inline">
                            	<div class="mws-form-row">
                                	<label class="mws-form-label">用户名</label>
                                	<div class="mws-form-item">
                                    	<input class="large" type="text" value="<?php echo ($name['name']); ?>" name="name" required oninvalid="setCustomValidity('用户名不能为空')" oninput="setCustomValidity('')">
                                    </div>
                                </div>                                                        	
                                <div class="mws-form-row">
                                    <label class="mws-form-label">邮箱</label>
                                    <div class="mws-form-item">
                                        <input class="large" type="text" value="<?php echo ($name['email']); ?>" name="email" required oninvalid="setCustomValidity('密码不能为空')" oninput="setCustomValidity('')">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">密码</label>
                                    <div class="mws-form-item">
                                        <input class="large" type="password" name="pwd" required oninvalid="setCustomValidity('密码不能为空')" oninput="setCustomValidity('')">
                                    </div>
                                </div> 
                                <div class="mws-form-row">
                                    <label class="mws-form-label">确认密码</label>
                                    <div class="mws-form-item">
                                        <input class="large" type="password" name="repwd" required oninvalid="setCustomValidity('请确认密码')" oninput="setCustomValidity('')">
                                    </div>
                                </div>  
