	...
	<div class="m_content">
   		<div class="m_left">
            ...
            <table border="0" class="order_tab" style="width:930px; text-align:center; margin-bottom:30px;" cellspacing="0" cellpadding="0">
              <tr>                                                   
                <td width="25%">订单号</td>
                <td width="25%"><?php echo ($order['oid']); ?></td>
                <td width="25%">下单时间</td>
                <td width="25%"><?php echo ($order['addtime']); ?></td>
              </tr>
              <tr>                                                   
                <td width="25%">收货人</td>
                <td width="25%"><?php echo ($order['likeman']); ?></td>
                <td width="25%">订单总金额</td>
                <td width="25%"><?php echo ($order['total']); ?></td>
              </tr>
              <tr>                                                   
              ...
              <tr>
                <td colspan="4" width="100%">
                  <div class="price_a"><a href="/index.php/Home/order/orders" class="btn btn-success">返回订单页</a></div>
                </td>
              </tr>
            </table>
